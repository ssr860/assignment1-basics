...
def run_get_batch(
    ...
    """
    return training_utilities.data_loading(
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return training_utilities.gradient_clipping(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return training_utilities.learning_rate_schedule(
        it,
        max_learning_rate,
        min_learning_rate,
        warmup_iters,
...
def run_save_checkpoint(
    ...
    """
    return training_utilities.save_checkpoint(
...
def run_load_checkpoint(
    ...
    """
    return training_utilities.load_checkpoint(
        src, model, optimizer,
    )
